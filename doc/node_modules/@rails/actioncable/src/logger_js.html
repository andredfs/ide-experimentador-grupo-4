...
<main role="main" aria-label="Page node_modules/@rails/actioncable/src/logger.js">

<p>import adapters from “./adapters”</p>

<p>// The logger is disabled by default. You can enable it with: // //   ActionCable.logger.enabled = true // //   Example: // //   import * as ActionCable from ‘@rails/actioncable’ // //   ActionCable.logger.enabled = true //   ActionCable.logger.log(‘Connection Established.’) //</p>
