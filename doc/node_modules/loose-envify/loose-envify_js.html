...
<title>loose-envify.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/loose-envify/loose-envify.js">

<p>‘use strict’;</p>

<p>var stream = require(‘stream’); var util = require(‘util’); var replace = require(‘./replace’);</p>

<p>var jsonExtRe = /.json$/;</p>

<p>module.exports = function(rootEnv) {</p>

<pre>rootEnv = rootEnv || process.env;
...
<p>function LooseEnvify(envs) {</p>

<pre class="ruby"><span class="ruby-identifier">stream</span>.<span class="ruby-constant">Transform</span>.<span class="ruby-identifier">call</span>(<span class="ruby-identifier">this</span>);
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">_data</span> = <span class="ruby-string">&#39;&#39;</span>;
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">_envs</span> = <span class="ruby-identifier">envs</span>;
</pre>

<p>} util.inherits(LooseEnvify, stream.Transform);</p>

<p>LooseEnvify.prototype._transform = function(buf, enc, cb) {</p>

<pre class="ruby"><span class="ruby-identifier">this</span>.<span class="ruby-identifier">_data</span> <span class="ruby-operator">+=</span> <span class="ruby-identifier">buf</span>;
<span class="ruby-identifier">cb</span>();
</pre>

<p>};</p>

<p>LooseEnvify.prototype._flush = function(cb) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">replaced</span> = <span class="ruby-identifier">replace</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">_data</span>, <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_envs</span>);
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">push</span>(<span class="ruby-identifier">replaced</span>);
<span class="ruby-identifier">cb</span>();
</pre>
