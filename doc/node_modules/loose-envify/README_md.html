...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
              <li>
            <details open>
              <summary>      <a href="#label-loose-envify">loose-envify</a>
</summary>
              <ul class="link-list" role="directory">
                          <li>      <a href="#label-Gotchas">Gotchas</a>
          <li>      <a href="#label-Usage-2FOptions">Usage/Options</a>
...
<main role="main" aria-label="Page node_modules/loose-envify/README.md">

<h1 id="label-loose-envify">loose-envify<span><a href="#label-loose-envify">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://travis-ci.org/zertosh/loose-envify"><img src="https://travis-ci.org/zertosh/loose-envify.svg?branch=master"></a></p>

<p>Fast (and loose) selective <code>process.env</code> replacer using <a href="https://github.com/lydell/js-tokens">js-tokens</a> instead of an AST. Works just like <a href="https://github.com/hughsk/envify">envify</a> but much faster.</p>

<h2 id="label-Gotchas">Gotchas<span><a href="#label-Gotchas">&para;</a> <a href="#top">&uarr;</a></span></h2>
<ul><li>
<p>Doesn’t handle broken syntax.</p>
</li><li>
<p>Doesn’t look inside embedded expressions in template strings.</p>
</li><li>
<p><strong>this won’t work:</strong> <code>js  console.log(`the current env is ${process.env.NODE_ENV}`); </code></p>
</li><li>
<p>Doesn’t replace oddly-spaced or oddly-commented expressions.</p>
</li><li>
<p><strong>this won’t work:</strong> <code>js  console.log(process./*won&#39;t*/env./<strong>work</strong>/NODE_ENV); </code></p>
</li></ul>

<h2 id="label-Usage-2FOptions">Usage/Options<span><a href="#label-Usage-2FOptions">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>loose-envify has the exact same interface as <a href="https://github.com/hughsk/envify">envify</a>, including the CLI.</p>
