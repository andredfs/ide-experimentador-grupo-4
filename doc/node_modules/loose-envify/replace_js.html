...
<title>replace.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/loose-envify/replace.js">

<p>‘use strict’;</p>

<p>var jsTokens = require(‘js-tokens’).default;</p>

<p>var processEnvRe = /<a href=“_$a-zA-Z”>bprocess.env.</a>[$w]+b/; var spaceOrCommentRe = /^(?:<a href=“/*”>s|/</a>)/;</p>

<p>function replace(src, envs) {</p>

<pre>if (!processEnvRe.test(src)) {
  return src;
}
...
<p>function getAdjacentCodeToken(dir, parts, i) {</p>
...
<p>function getReplacementString(envs, name, purge) {</p>

<pre>for (var j = 0; j &lt; envs.length; j++) {
  var env = envs[j];
