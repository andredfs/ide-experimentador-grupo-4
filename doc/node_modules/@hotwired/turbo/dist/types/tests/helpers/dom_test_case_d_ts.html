...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/tests/helpers/dom_test_case.d.ts">

<p>export declare class DOMTestCase {</p>

<pre>fixtureElement: HTMLElement;
setup(): Promise&lt;void&gt;;
teardown(): Promise&lt;void&gt;;
append(node: Node): void;
find(selector: string): Element | null;
get fixtureHTML(): string;
set fixtureHTML(html: string);</pre>
