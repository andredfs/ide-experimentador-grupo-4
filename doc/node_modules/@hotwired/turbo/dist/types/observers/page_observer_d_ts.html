...
<title>page_observer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/observers/page_observer.d.ts">

<p>export interface PageObserverDelegate {</p>

<pre>pageBecameInteractive(): void;
pageLoaded(): void;
pageWillUnload(): void;</pre>

<p>} export declare enum PageStage {</p>

<pre class="ruby"><span class="ruby-identifier">initial</span> = <span class="ruby-value">0</span>,
<span class="ruby-identifier">loading</span> = <span class="ruby-value">1</span>,
<span class="ruby-identifier">interactive</span> = <span class="ruby-value">2</span>,
<span class="ruby-identifier">complete</span> = <span class="ruby-value">3</span>
</pre>

<p>} export declare class PageObserver {</p>

<pre>readonly delegate: PageObserverDelegate;
stage: PageStage;
started: boolean;
...
pageIsComplete(): void;
pageWillUnload: () =&gt; void;
get readyState(): DocumentReadyState;</pre>
