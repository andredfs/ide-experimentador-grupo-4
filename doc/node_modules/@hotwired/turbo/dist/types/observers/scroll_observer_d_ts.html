...
<title>scroll_observer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/observers/scroll_observer.d.ts">

<p>import { Position } from “../core/types”; export interface ScrollObserverDelegate {</p>

<pre>scrollPositionChanged(position: Position): void;</pre>

<p>} export declare class ScrollObserver {</p>

<pre>readonly delegate: ScrollObserverDelegate;
started: boolean;
constructor(delegate: ScrollObserverDelegate);
start(): void;
stop(): void;
onScroll: () =&gt; void;
updatePosition(position: Position): void;</pre>
