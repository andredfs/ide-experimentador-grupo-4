...
<title>appearance_observer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/observers/appearance_observer.d.ts">

<p>export interface AppearanceObserverDelegate&lt;T extends Element&gt; {</p>

<pre>elementAppearedInViewport(element: T): void;</pre>

<p>} export declare class AppearanceObserver&lt;T extends Element&gt; {</p>

<pre>readonly delegate: AppearanceObserverDelegate&lt;T&gt;;
readonly element: T;
...
start(): void;
stop(): void;
intersect: IntersectionObserverCallback;</pre>
