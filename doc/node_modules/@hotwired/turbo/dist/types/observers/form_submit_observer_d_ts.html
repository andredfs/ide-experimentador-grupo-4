...
<title>form_submit_observer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/observers/form_submit_observer.d.ts">

<p>export interface FormSubmitObserverDelegate {</p>

<pre>willSubmitForm(form: HTMLFormElement, submitter?: HTMLElement): boolean;
formSubmitted(form: HTMLFormElement, submitter?: HTMLElement): void;</pre>

<p>} export declare class FormSubmitObserver {</p>

<pre>readonly delegate: FormSubmitObserverDelegate;
...
stop(): void;
submitCaptured: () =&gt; void;
submitBubbled: EventListener;</pre>
