...
<title>form_link_click_observer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/observers/form_link_click_observer.d.ts">

<p>import { LinkClickObserver, LinkClickObserverDelegate } from “./link_click_observer”; export type FormLinkClickObserverDelegate = {</p>

<pre>willSubmitFormLinkToLocation(link: Element, location: URL, event: MouseEvent): boolean;
submittedFormLinkToLocation(link: Element, location: URL, form: HTMLFormElement): void;</pre>

<p>}; export declare class FormLinkClickObserver implements LinkClickObserverDelegate {</p>

<pre>readonly linkInterceptor: LinkClickObserver;
...
followedLinkToLocation(link: Element, location: URL): void;</pre>
