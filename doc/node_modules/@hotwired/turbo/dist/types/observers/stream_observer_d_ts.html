...
<title>stream_observer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/observers/stream_observer.d.ts">

<p>import { FetchResponse } from “../http/fetch_response”; import { StreamMessage } from “../core/streams/stream_message”; import { StreamSource } from “../core/types”; export interface StreamObserverDelegate {</p>

<pre>receivedMessageFromStream(message: StreamMessage): void;</pre>

<p>} export declare class StreamObserver {</p>

<pre>readonly delegate: StreamObserverDelegate;
...
receiveMessageHTML(html: string): void;</pre>
