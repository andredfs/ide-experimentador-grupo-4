...
<title>link_click_observer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/observers/link_click_observer.d.ts">

<p>export interface LinkClickObserverDelegate {</p>

<pre>willFollowLinkToLocation(link: Element, location: URL, event: MouseEvent): boolean;
followedLinkToLocation(link: Element, location: URL): void;</pre>

<p>} export declare class LinkClickObserver {</p>

<pre>readonly delegate: LinkClickObserverDelegate;
...
getLocationForLink(link: Element): URL;</pre>
