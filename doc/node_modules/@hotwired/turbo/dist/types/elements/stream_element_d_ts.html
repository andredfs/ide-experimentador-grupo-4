...
<title>stream_element.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/elements/stream_element.d.ts">

<p>type Render = (currentElement: StreamElement) =&gt; Promise&lt;void&gt;; export type TurboBeforeStreamRenderEvent = CustomEvent&lt;{</p>

<pre>newStream: StreamElement;
render: Render;</pre>

<p>}&gt;; export declare class StreamElement extends HTMLElement {</p>

<pre>static renderElement(newElement: StreamElement): Promise&lt;void&gt;;
...
private get targetElementsByQuery();</pre>
