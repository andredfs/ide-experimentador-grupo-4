...
<title>frame_element.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/elements/frame_element.d.ts">

<p>import { FetchResponse } from “../http/fetch_response”; import { Snapshot } from “../core/snapshot”; import { LinkInterceptorDelegate } from “../core/frames/link_interceptor”; import { FormSubmitObserverDelegate } from “../observers/form_submit_observer”; export declare enum FrameLoadingStyle {</p>

<pre class="ruby"><span class="ruby-identifier">eager</span> = <span class="ruby-string">&quot;eager&quot;</span>,
<span class="ruby-identifier">lazy</span> = <span class="ruby-string">&quot;lazy&quot;</span>
</pre>

<p>} export type FrameElementObservedAttribute = keyof FrameElement &amp; (“disabled” | “complete” | “loading” | “src”); export interface FrameElementDelegate extends LinkInterceptorDelegate, FormSubmitObserverDelegate {</p>
...
isLoading: boolean;</pre>

<p>} export declare class FrameElement extends HTMLElement {</p>

<pre>static delegateConstructor: new (element: FrameElement) =&gt; FrameElementDelegate;
loaded: Promise&lt;void&gt;;
