...
<title>view.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/view.d.ts">

<p>import { ReloadReason } from “./native/browser_adapter”; import { Renderer, Render } from “./renderer”; import { Snapshot } from “./snapshot”; import { Position } from “./types”; export interface ViewRenderOptions&lt;E&gt; {</p>

<pre>resume: (value?: any) =&gt; void;
render: Render&lt;E&gt;;</pre>

<p>} export interface ViewDelegate&lt;E extends Element, S extends Snapshot&lt;E&gt;&gt; {</p>

<pre>allowsImmediateRender(snapshot: S, options: ViewRenderOptions&lt;E&gt;): boolean;
preloadOnLoadLinksForView(element: Element): void;
viewRenderedSnapshot(snapshot: S, isPreview: boolean): void;
viewInvalidated(reason: ReloadReason): void;</pre>

<p>} export declare abstract class View&lt;E extends Element, S extends Snapshot&lt;E&gt; = Snapshot&lt;E&gt;, R extends Renderer&lt;E, S&gt; = Renderer&lt;E, S&gt;, D extends ViewDelegate&lt;E, S&gt; = ViewDelegate&lt;E, S&gt;&gt; {</p>

<pre>readonly delegate: D;
readonly element: E;
renderer?: R;
...
finishRenderingSnapshot(renderer: R): void;</pre>
