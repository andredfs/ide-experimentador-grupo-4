...
<title>link_interceptor.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/frames/link_interceptor.d.ts">

<p>export interface LinkInterceptorDelegate {</p>

<pre>shouldInterceptLinkClick(element: Element, url: string, originalEvent: MouseEvent): boolean;
linkClickIntercepted(element: Element, url: string, originalEvent: MouseEvent): void;</pre>

<p>} export declare class LinkInterceptor {</p>

<pre>readonly delegate: LinkInterceptorDelegate;
...
respondsToEventTarget(target: EventTarget | null): boolean | null;</pre>
