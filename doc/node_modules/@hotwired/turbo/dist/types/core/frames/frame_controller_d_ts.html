...
<title>frame_controller.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/frames/frame_controller.d.ts">

<p>import { FrameElement, FrameElementDelegate, FrameLoadingStyle } from “../../elements/frame_element”; import { FetchRequest, FetchRequestDelegate } from “../../http/fetch_request”; import { FetchResponse } from “../../http/fetch_response”; import { AppearanceObserver, AppearanceObserverDelegate } from “../../observers/appearance_observer”; import { FormSubmission, FormSubmissionDelegate } from “../drive/form_submission”; import { Snapshot } from “../snapshot”; import { ViewDelegate, ViewRenderOptions } from “../view”; import { Locatable } from “../url”; import { FormSubmitObserver, FormSubmitObserverDelegate } from “../../observers/form_submit_observer”; import { FrameView } from “./frame_view”; import { LinkInterceptor, LinkInterceptorDelegate } from “./link_interceptor”; import { FormLinkClickObserver, FormLinkClickObserverDelegate } from “../../observers/form_link_click_observer”; import { VisitOptions } from “../drive/visit”; type VisitFallback = (location: Response | Locatable, options: Partial&lt;VisitOptions&gt;) =&gt; Promise&lt;void&gt;; export type TurboFrameMissingEvent = CustomEvent&lt;{</p>

<pre>response: Response;
visit: VisitFallback;</pre>

<p>}&gt;; export declare class FrameController implements AppearanceObserverDelegate&lt;FrameElement&gt;, FetchRequestDelegate, FormSubmitObserverDelegate, FormSubmissionDelegate, FrameElementDelegate, FormLinkClickObserverDelegate, LinkInterceptorDelegate, ViewDelegate&lt;FrameElement, Snapshot&lt;FrameElement&gt;&gt; {</p>

<pre>readonly element: FrameElement;
...
private withCurrentNavigationElement;</pre>
