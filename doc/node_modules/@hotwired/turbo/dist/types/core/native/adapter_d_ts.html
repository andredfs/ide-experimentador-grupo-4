...
<title>adapter.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/native/adapter.d.ts">

<p>import { Visit, VisitOptions } from “../drive/visit”; import { FormSubmission } from “../drive/form_submission”; import { ReloadReason } from “./browser_adapter”; export interface Adapter {</p>

<pre>visitProposedToLocation(location: URL, options?: Partial&lt;VisitOptions&gt;): void;
...
pageInvalidated(reason: ReloadReason): void;</pre>
