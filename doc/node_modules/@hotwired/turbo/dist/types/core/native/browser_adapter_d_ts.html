...
<title>browser_adapter.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/native/browser_adapter.d.ts">

<p>import { Adapter } from “./adapter”; import { ProgressBar } from “../drive/progress_bar”; import { Visit, VisitOptions } from “../drive/visit”; import { FormSubmission } from “../drive/form_submission”; import { Session } from “../session”; export type ReloadReason = StructuredReason | undefined; interface StructuredReason {</p>
...
<p>} export declare class BrowserAdapter implements Adapter {</p>

<pre>readonly session: Session;
...
get navigator(): import(&quot;../drive/navigator&quot;).Navigator;</pre>
