...
<title>stream_message_renderer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/streams/stream_message_renderer.d.ts">

<p>import { StreamMessage } from “./stream_message”; import { BardoDelegate } from “../bardo”; export declare class StreamMessageRenderer implements BardoDelegate {</p>

<pre>render({ fragment }: StreamMessage): void;
enteringBardo(currentPermanentElement: Element, newPermanentElement: Element): void;
leavingBardo(): void;</pre>
