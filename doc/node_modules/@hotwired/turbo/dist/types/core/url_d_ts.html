...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/url.d.ts">

<p>export type Locatable = URL | string; export declare function expandURL(locatable: Locatable): URL; export declare function getAnchor(url: URL): string | undefined; export declare function getAction(form: HTMLFormElement, submitter?: HTMLElement): URL; export declare function getExtension(url: URL): string; export declare function isHTML(url: URL): boolean; export declare function isPrefixedBy(baseURL: URL, url: URL): boolean; export declare function locationIsVisitable(location: URL, rootLocation: URL): boolean; export declare function getRequestURL(url: URL): string; export declare function toCacheKey(url: URL): string; export declare function urlsAreEqual(left: string, right: string): boolean;</p>
