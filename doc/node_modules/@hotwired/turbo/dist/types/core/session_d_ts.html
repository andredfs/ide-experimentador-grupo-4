...
<title>session.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/session.d.ts">

<p>import { Adapter } from “./native/adapter”; import { ReloadReason } from “./native/browser_adapter”; import { CacheObserver } from “../observers/cache_observer”; import { FormSubmitObserver, FormSubmitObserverDelegate } from “../observers/form_submit_observer”; import { FrameRedirector } from “./frames/frame_redirector”; import { History, HistoryDelegate } from “./drive/history”; import { LinkClickObserver, LinkClickObserverDelegate } from “../observers/link_click_observer”; import { FormLinkClickObserver, FormLinkClickObserverDelegate } from “../observers/form_link_click_observer”; import { Locatable } from “./url”; import { Navigator, NavigatorDelegate } from “./drive/navigator”; import { PageObserver, PageObserverDelegate } from “../observers/page_observer”; import { ScrollObserver } from “../observers/scroll_observer”; import { StreamMessage } from “./streams/stream_message”; import { StreamMessageRenderer } from “./streams/stream_message_renderer”; import { StreamObserver } from “../observers/stream_observer”; import { Action, Position, StreamSource } from “./types”; import { PageView, PageViewDelegate, PageViewRenderOptions } from “./drive/page_view”; import { Visit, VisitOptions } from “./drive/visit”; import { PageSnapshot } from “./drive/page_snapshot”; import { FrameElement } from “../elements/frame_element”; import { FrameViewRenderOptions } from “./frames/frame_view”; import { FetchResponse } from “../http/fetch_response”; import { Preloader, PreloaderDelegate } from “./drive/preloader”; export type FormMode = “on” | “off” | “optin”; export type TimingData = unknown; export type TurboBeforeCacheEvent = CustomEvent; export type TurboBeforeRenderEvent = CustomEvent&lt;{</p>

<pre>newBody: HTMLBodyElement;</pre>

<p>} &amp; PageViewRenderOptions&gt;; export type TurboBeforeVisitEvent = CustomEvent&lt;{</p>

<pre>url: string;</pre>

<p>}&gt;; export type TurboClickEvent = CustomEvent&lt;{</p>

<pre>url: string;
originalEvent: MouseEvent;</pre>

<p>}&gt;; export type TurboFrameLoadEvent = CustomEvent; export type TurboBeforeFrameRenderEvent = CustomEvent&lt;{</p>

<pre>newFrame: FrameElement;</pre>

<p>} &amp; FrameViewRenderOptions&gt;; export type TurboFrameRenderEvent = CustomEvent&lt;{</p>

<pre>fetchResponse: FetchResponse;</pre>

<p>}&gt;; export type TurboLoadEvent = CustomEvent&lt;{</p>

<pre>url: string;
timing: TimingData;</pre>

<p>}&gt;; export type TurboRenderEvent = CustomEvent; export type TurboVisitEvent = CustomEvent&lt;{</p>

<pre>url: string;
action: Action;</pre>

<p>}&gt;; export declare class Session implements FormSubmitObserverDelegate, HistoryDelegate, FormLinkClickObserverDelegate, LinkClickObserverDelegate, NavigatorDelegate, PageObserverDelegate, PageViewDelegate, PreloaderDelegate {</p>

<pre>readonly navigator: Navigator;
