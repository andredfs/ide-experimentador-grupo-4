...
<title>snapshot.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/snapshot.d.ts">

<p>export declare class Snapshot&lt;E extends Element = Element&gt; {</p>

<pre>readonly element: E;
...
getPermanentElementMapForSnapshot(snapshot: Snapshot): PermanentElementMap;</pre>

<p>} export declare function getPermanentElementById(node: ParentNode, id: string): Element | null; export declare function queryPermanentElementsAll(node: ParentNode): NodeListOf&lt;Element&gt;; export type PermanentElementMap = Record&lt;string, [Element, Element]&gt;;</p>
