...
<title>renderer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/renderer.d.ts">

<p>import { BardoDelegate } from “./bardo”; import { Snapshot } from “./snapshot”; import { ReloadReason } from “./native/browser_adapter”; export type Render&lt;E&gt; = (currentElement: E, newElement: E) =&gt; void; export declare abstract class Renderer&lt;E extends Element, S extends Snapshot&lt;E&gt; = Snapshot&lt;E&gt;&gt; implements BardoDelegate {</p>

<pre>readonly currentSnapshot: S;
...
get newElement(): E;
get permanentElementMap(): import(&quot;./snapshot&quot;).PermanentElementMap;</pre>
