...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/types.d.ts">

<p>export type Action = “advance” | “replace” | “restore”; export type Position = {</p>

<pre>x: number;
y: number;</pre>

<p>}; export type StreamSource = {</p>

<pre>addEventListener(type: &quot;message&quot;, listener: (event: MessageEvent) =&gt; void, options?: boolean | AddEventListenerOptions): void;
removeEventListener(type: &quot;message&quot;, listener: (event: MessageEvent) =&gt; void, options?: boolean | EventListenerOptions): void;</pre>
