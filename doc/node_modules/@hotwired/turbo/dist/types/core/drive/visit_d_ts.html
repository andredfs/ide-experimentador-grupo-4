...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/drive/visit.d.ts">

<p>import { Adapter } from “../native/adapter”; import { FetchRequest, FetchRequestDelegate } from “../../http/fetch_request”; import { FetchResponse } from “../../http/fetch_response”; import { History } from “./history”; import { Snapshot } from “../snapshot”; import { PageSnapshot } from “./page_snapshot”; import { Action } from “../types”; import { PageView } from “./page_view”; export interface VisitDelegate {</p>

<pre>readonly adapter: Adapter;
readonly history: History;
readonly view: PageView;
visitStarted(visit: Visit): void;
visitCompleted(visit: Visit): void;
locationWithActionIsSamePage(location: URL, action: Action): boolean;
visitScrolledToSamePageLocation(oldURL: URL, newURL: URL): void;</pre>

<p>} export declare enum TimingMetric {</p>

<pre class="ruby"><span class="ruby-identifier">visitStart</span> = <span class="ruby-string">&quot;visitStart&quot;</span>,
<span class="ruby-identifier">requestStart</span> = <span class="ruby-string">&quot;requestStart&quot;</span>,
<span class="ruby-identifier">requestEnd</span> = <span class="ruby-string">&quot;requestEnd&quot;</span>,
<span class="ruby-identifier">visitEnd</span> = <span class="ruby-string">&quot;visitEnd&quot;</span>
</pre>

<p>} export type TimingMetrics = Partial&lt;{</p>

<pre>[metric in TimingMetric]: any;</pre>

<p>}&gt;; export declare enum VisitState {</p>

<pre class="ruby"><span class="ruby-identifier">initialized</span> = <span class="ruby-string">&quot;initialized&quot;</span>,
<span class="ruby-identifier">started</span> = <span class="ruby-string">&quot;started&quot;</span>,
<span class="ruby-identifier">canceled</span> = <span class="ruby-string">&quot;canceled&quot;</span>,
<span class="ruby-identifier">failed</span> = <span class="ruby-string">&quot;failed&quot;</span>,
<span class="ruby-identifier">completed</span> = <span class="ruby-string">&quot;completed&quot;</span>
</pre>

<p>} export type VisitOptions = {</p>
...
frame?: string;
acceptsStreamResponse: boolean;</pre>

<p>}; export type VisitResponse = {</p>

<pre>statusCode: number;
redirected: boolean;
responseHTML?: string;</pre>

<p>}; export declare enum SystemStatusCode {</p>

<pre class="ruby"><span class="ruby-identifier">networkFailure</span> = <span class="ruby-value">0</span>,
<span class="ruby-identifier">timeoutFailure</span> = <span class="ruby-value">-1</span>,
<span class="ruby-identifier">contentTypeMismatch</span> = <span class="ruby-value">-2</span>
</pre>

<p>} export declare class Visit implements FetchRequestDelegate {</p>

<pre>readonly delegate: VisitDelegate;
