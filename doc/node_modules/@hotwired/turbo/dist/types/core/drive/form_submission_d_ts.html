...
<title>form_submission.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/drive/form_submission.d.ts">

<p>import { FetchRequest, FetchMethod } from “../../http/fetch_request”; import { FetchResponse } from “../../http/fetch_response”; export interface FormSubmissionDelegate {</p>

<pre>formSubmissionStarted(formSubmission: FormSubmission): void;
...
formSubmissionFinished(formSubmission: FormSubmission): void;</pre>

<p>} export type FormSubmissionResult = {</p>

<pre>success: boolean;
fetchResponse: FetchResponse;</pre>
...
<p>}; export declare enum FormSubmissionState {</p>

<pre class="ruby"><span class="ruby-identifier">initialized</span> = <span class="ruby-value">0</span>,
<span class="ruby-identifier">requesting</span> = <span class="ruby-value">1</span>,
<span class="ruby-identifier">waiting</span> = <span class="ruby-value">2</span>,
<span class="ruby-identifier">receiving</span> = <span class="ruby-value">3</span>,
<span class="ruby-identifier">stopping</span> = <span class="ruby-value">4</span>,
<span class="ruby-identifier">stopped</span> = <span class="ruby-value">5</span>
</pre>

<p>} declare enum FormEnctype {</p>

<pre class="ruby"><span class="ruby-identifier">urlEncoded</span> = <span class="ruby-string">&quot;application/x-www-form-urlencoded&quot;</span>,
<span class="ruby-identifier">multipart</span> = <span class="ruby-string">&quot;multipart/form-data&quot;</span>,
<span class="ruby-identifier">plain</span> = <span class="ruby-string">&quot;text/plain&quot;</span>
</pre>

<p>} export type TurboSubmitStartEvent = CustomEvent&lt;{</p>

<pre>formSubmission: FormSubmission;</pre>

<p>}&gt;; export type TurboSubmitEndEvent = CustomEvent&lt;{</p>

<pre>formSubmission: FormSubmission;</pre>

<p>} &amp; {</p>

<pre>[K in keyof FormSubmissionResult]?: FormSubmissionResult[K];</pre>

<p>}&gt;; export declare class FormSubmission {</p>

<pre>readonly delegate: FormSubmissionDelegate;
...
get submitsWith(): string | null | undefined;</pre>
