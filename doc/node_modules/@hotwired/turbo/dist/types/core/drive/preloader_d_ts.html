...
<title>preloader.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/drive/preloader.d.ts">

<p>import { Navigator } from “./navigator”; import { SnapshotCache } from “./snapshot_cache”; export interface PreloaderDelegate {</p>

<pre class="ruby"><span class="ruby-identifier">readonly</span> <span class="ruby-value">navigator:</span> <span class="ruby-constant">Navigator</span>;
</pre>

<p>} export declare class Preloader {</p>

<pre>readonly delegate: PreloaderDelegate;
readonly selector: string;
constructor(delegate: PreloaderDelegate);
get snapshotCache(): SnapshotCache;
start(): void;
preloadOnLoadLinksForView(element: Element): void;
preloadURL(link: HTMLAnchorElement): Promise&lt;void&gt;;</pre>
