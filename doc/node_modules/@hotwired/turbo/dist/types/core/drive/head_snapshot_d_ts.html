...
<title>head_snapshot.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/drive/head_snapshot.d.ts">

<p>import { Snapshot } from “../snapshot”; type ElementDetailMap = {</p>

<pre>[outerHTML: string]: ElementDetails;</pre>

<p>}; type ElementDetails = {</p>

<pre>type?: ElementType;
tracked: boolean;
elements: Element[];</pre>

<p>}; type ElementType = “script” | “stylesheet”; export declare class HeadSnapshot extends Snapshot&lt;HTMLHeadElement&gt; {</p>

<pre>readonly detailsByOuterHTML: ElementDetailMap;
...
findMetaElementByName(name: string): Element | undefined;</pre>
