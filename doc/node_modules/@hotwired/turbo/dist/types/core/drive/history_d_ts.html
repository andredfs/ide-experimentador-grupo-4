...
<title>history.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/drive/history.d.ts">

<p>import { Position } from “../types”; export interface HistoryDelegate {</p>

<pre>historyPoppedToLocationWithRestorationIdentifier(location: URL, restorationIdentifier: string): void;</pre>

<p>} type HistoryMethod = (this: typeof history, state: any, title: string, url?: string | null | undefined) =&gt; void; export type RestorationData = {</p>

<pre>scrollPosition?: Position;</pre>

<p>}; export type RestorationDataMap = {</p>

<pre>[restorationIdentifier: string]: RestorationData;</pre>

<p>}; export declare class History {</p>

<pre>readonly delegate: HistoryDelegate;
location: URL;
