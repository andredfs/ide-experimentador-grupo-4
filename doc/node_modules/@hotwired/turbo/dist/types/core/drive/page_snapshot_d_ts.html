...
<title>page_snapshot.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/drive/page_snapshot.d.ts">

<p>import { Snapshot } from “../snapshot”; import { HeadSnapshot } from “./head_snapshot”; export declare class PageSnapshot extends Snapshot&lt;HTMLBodyElement&gt; {</p>

<pre>static fromHTMLString(html?: string): PageSnapshot;
...
getSetting(name: string): string | null;</pre>
