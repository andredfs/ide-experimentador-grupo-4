...
<title>page_view.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/drive/page_view.d.ts">

<p>import { View, ViewDelegate, ViewRenderOptions } from “../view”; import { ErrorRenderer } from “./error_renderer”; import { PageRenderer } from “./page_renderer”; import { PageSnapshot } from “./page_snapshot”; import { SnapshotCache } from “./snapshot_cache”; import { Visit } from “./visit”; export type PageViewRenderOptions = ViewRenderOptions&lt;HTMLBodyElement&gt;; export interface PageViewDelegate extends ViewDelegate&lt;HTMLBodyElement, PageSnapshot&gt; {</p>

<pre>viewWillCacheSnapshot(): void;</pre>

<p>} type PageViewRenderer = PageRenderer | ErrorRenderer; export declare class PageView extends View&lt;HTMLBodyElement, PageSnapshot, PageViewRenderer, PageViewDelegate&gt; {</p>

<pre>readonly snapshotCache: SnapshotCache;
