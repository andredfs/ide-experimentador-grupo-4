...
<title>navigator.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/drive/navigator.d.ts">

<p>import { Action } from “../types”; import { FetchResponse } from “../../http/fetch_response”; import { FormSubmission } from “./form_submission”; import { Locatable } from “../url”; import { Visit, VisitDelegate, VisitOptions } from “./visit”; export type NavigatorDelegate = VisitDelegate &amp; {</p>

<pre>allowsVisitingLocationWithAction(location: URL, action?: Action): boolean;
visitProposedToLocation(location: URL, options: Partial&lt;VisitOptions&gt;): void;
notifyApplicationAfterVisitingSamePageLocation(oldURL: URL, newURL: URL): void;</pre>

<p>}; export declare class Navigator {</p>

<pre>readonly delegate: NavigatorDelegate;
...
getActionForFormSubmission({ submitter, formElement }: FormSubmission): Action;</pre>
