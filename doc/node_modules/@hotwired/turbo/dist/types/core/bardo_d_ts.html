...
<title>bardo.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/core/bardo.d.ts">

<p>import { PermanentElementMap } from “./snapshot”; export interface BardoDelegate {</p>

<pre>enteringBardo(currentPermanentElement: Element, newPermanentElement: Element): void;
leavingBardo(currentPermanentElement: Element): void;</pre>

<p>} export declare class Bardo {</p>

<pre>readonly permanentElementMap: PermanentElementMap;
...
get placeholders(): HTMLMetaElement[];</pre>
