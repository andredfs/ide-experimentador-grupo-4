...
<title>fetch_request.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/dist/types/http/fetch_request.d.ts">

<p>import { FetchResponse } from “./fetch_response”; import { FrameElement } from “../elements/frame_element”; export type TurboBeforeFetchRequestEvent = CustomEvent&lt;{</p>

<pre>fetchOptions: RequestInit;
url: URL;
resume: (value?: any) =&gt; void;</pre>

<p>}&gt;; export type TurboBeforeFetchResponseEvent = CustomEvent&lt;{</p>

<pre>fetchResponse: FetchResponse;</pre>

<p>}&gt;; export type TurboFetchRequestErrorEvent = CustomEvent&lt;{</p>

<pre>request: FetchRequest;
error: Error;</pre>

<p>}&gt;; export interface FetchRequestDelegate {</p>
...
requestFinished(request: FetchRequest): void;</pre>

<p>} export declare enum FetchMethod {</p>

<pre class="ruby"><span class="ruby-identifier">get</span> = <span class="ruby-value">0</span>,
<span class="ruby-identifier">post</span> = <span class="ruby-value">1</span>,
<span class="ruby-identifier">put</span> = <span class="ruby-value">2</span>,
<span class="ruby-identifier">patch</span> = <span class="ruby-value">3</span>,
<span class="ruby-identifier">delete</span> = <span class="ruby-value">4</span>
</pre>

<p>} export declare function fetchMethodFromString(method: string): FetchMethod | undefined; export type FetchRequestBody = FormData | URLSearchParams; export type FetchRequestHeaders = {</p>

<pre>[header: string]: string;</pre>

<p>}; export interface FetchRequestOptions {</p>

<pre>headers: FetchRequestHeaders;
body: FetchRequestBody;
followRedirects: boolean;</pre>

<p>} export declare class FetchRequest {</p>

<pre>readonly delegate: FetchRequestDelegate;
...
private willDelegateErrorHandling;</pre>
