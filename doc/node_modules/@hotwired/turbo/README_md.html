...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
              <li>
            <details open>
              <summary>      <a href="#label-Turbo">Turbo</a>
</summary>
              <ul class="link-list" role="directory">
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo/README.md">

<h1 id="label-Turbo">Turbo<span><a href="#label-Turbo">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Turbo uses complementary techniques to dramatically reduce the amount of custom JavaScript that most web applications will need to write:</p>
<ul><li>
<p>Turbo Drive accelerates links and form submissions by negating the need for full page reloads.</p>
</li><li>
<p>Turbo Frames decompose pages into independent contexts, which scope navigation and can be lazily loaded.</p>
</li><li>
<p>Turbo Streams deliver page changes over WebSocket or in response to form submissions using just HTML and a set of CRUD-like actions.</p>
</li><li>
<p>Turbo Native lets your majestic monolith form the center of your native iOS and Android apps, with seamless transitions between web and native sections.</p>
</li></ul>

<p>It’s all done by sending HTML over the wire. And for those instances when that’s not enough, you can reach for the other side of Hotwire, and finish the job with <a href="https://github.com/hotwired/stimulus">Stimulus</a>.</p>

<p>Read more on <a href="https://turbo.hotwired.dev">turbo.hotwired.dev</a>.</p>

<h2 id="label-Contributing">Contributing<span><a href="#label-Contributing">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Please read <a href="./CONTRIBUTING_md.html">CONTRIBUTING.md</a>.</p>

<p>© 2021 37signals LLC.</p>
