...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
              <li>
            <details open>
              <summary>      <a href="#label-3Cimg+src-3D-22assets-2Flogo.png-3Fsanitize-3Dtrue-22+width-3D-2224-22+height-3D-2224-22+alt-3D-22Turbo-22-3E+Turbo">&lt;img src=“assets/logo.png?sanitize=true” width=“24” height=“24” alt=“Turbo”&gt; Turbo</a>
</summary>
              <ul class="link-list" role="directory">
                          <li>      <a href="#label-Navigate+with+Turbo+Drive">Navigate with Turbo Drive</a>
          <li>      <a href="#label-Decompose+with+Turbo+Frames">Decompose with Turbo Frames</a>
          <li>      <a href="#label-Come+Alive+with+Turbo+Streams">Come Alive with Turbo Streams</a>
          <li>      <a href="#label-Installation">Installation</a>
          <li>      <a href="#label-Usage">Usage</a>
          <li>      <a href="#label-Compatibility+with+Rails+UJS">Compatibility with Rails UJS</a>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo-rails/README.md">

<h1 id="label-3Cimg+src-3D-22assets-2Flogo.png-3Fsanitize-3Dtrue-22+width-3D-2224-22+height-3D-2224-22+alt-3D-22Turbo-22-3E+Turbo">&lt;img src=“assets/logo.png?sanitize=true” width=“24” height=“24” alt=“Turbo”&gt; Turbo<span><a href="#label-3Cimg+src-3D-22assets-2Flogo.png-3Fsanitize-3Dtrue-22+width-3D-2224-22+height-3D-2224-22+alt-3D-22Turbo-22-3E+Turbo">&para;</a> <a href="#top">&uarr;</a></span></h1>
...
<h2 id="label-Navigate+with+Turbo+Drive">Navigate with Turbo Drive<span><a href="#label-Navigate+with+Turbo+Drive">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<pre>import { Turbo } from &quot;@hotwired/turbo-rails&quot;
Turbo.session.drive = false</pre>
...
<h2 id="label-Decompose+with+Turbo+Frames">Decompose with Turbo Frames<span><a href="#label-Decompose+with+Turbo+Frames">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<pre>&lt;%# app/views/todos/show.html.erb %&gt;
...
<p>When the user will click on the <code>Edit this todo</code> link, as direct response to this direct user interaction, the turbo frame will be replaced with the one in the <code>edit.html.erb</code> page automatically.</p>

<p><a href="https://turbo.hotwired.dev/handbook/frames">See documentation</a>.</p>

<h2 id="label-Come+Alive+with+Turbo+Streams">Come Alive with Turbo Streams<span><a href="#label-Come+Alive+with+Turbo+Streams">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<ol><li>
<p>Add the <code>turbo-rails</code> gem to your Gemfile: <code>gem &#39;turbo-rails&#39;</code></p>
</li><li>
<p>Run <code>./bin/bundle install</code></p>
</li><li>
<p>Run <code>./bin/rails turbo:install</code></p>
</li><li>
<p>Run <code>./bin/rails turbo:install:redis</code> to change the development Action Cable adapter from Async (the default one) to Redis. The Async adapter does not support Turbo Stream broadcasting.</p>
</li></ol>

<p>Running <code>turbo:install</code> will install through NPM if Node.js is used in the application. Otherwise the asset pipeline version is used. To use the asset pipeline version, you must have <code>importmap-rails</code> installed first and listed higher in the <a href="../../../Gemfile.html">Gemfile</a>.</p>

<p>If you’re using node and need to use the cable consumer, you can import {<code>cable</code><a href="https://github.com/hotwired/turbo-rails/blob/main/app/javascript/turbo/cable.js">}</a> (<code>import { cable } from &quot;@hotwired/turbo-rails&quot;</code>), but ensure that your application actually <em>uses</em> the members it <code>import</code>s when using this style (see <a href="https://github.com/hotwired/turbo-rails/issues/48">turbo-rails#48</a>).</p>

<p>The <code>Turbo</code> instance is automatically assigned to <code>window.Turbo</code> upon import:</p>

<pre class="ruby"><span class="ruby-identifier">import</span> <span class="ruby-string">&quot;@hotwired/turbo-rails&quot;</span>
</pre>

<h2 id="label-Usage">Usage<span><a href="#label-Usage">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>You can watch <a href="https://hotwired.dev/#screencast">the video introduction to Hotwire</a>, which focuses extensively on demonstrating Turbo in a Rails demo. Then you should familiarize yourself with <a href="https://turbo.hotwired.dev/handbook/introduction">Turbo handbook</a> to understand Drive, Frames, and Streams in-depth. Finally, dive into the code documentation by starting with {<code>Turbo::FramesHelper</code><a href="https://github.com/hotwired/turbo-rails/blob/main/app/helpers/turbo/frames_helper.rb">}</a>, {<code>Turbo::StreamsHelper</code><a href="https://github.com/hotwired/turbo-rails/blob/main/app/helpers/turbo/streams_helper.rb">}</a>, {<code>Turbo::Streams::TagBuilder</code><a href="https://github.com/hotwired/turbo-rails/blob/main/app/models/turbo/streams/tag_builder.rb">}</a>, and {<code>Turbo::Broadcastable</code><a href="https://github.com/hotwired/turbo-rails/blob/main/app/models/concerns/turbo/broadcastable.rb">}</a>.</p>

<h2 id="label-Compatibility+with+Rails+UJS">Compatibility with Rails UJS<span><a href="#label-Compatibility+with+Rails+UJS">&para;</a> <a href="#top">&uarr;</a></span></h2>
