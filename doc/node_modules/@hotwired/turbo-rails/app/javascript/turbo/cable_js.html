...
<title>cable.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo-rails/app/javascript/turbo/cable.js">

<p>let consumer</p>

<p>export async function getConsumer() {</p>
...
<p>export function setConsumer(newConsumer) {</p>
...
<p>export async function createConsumer() {</p>

<pre>const { createConsumer } = await import(/* webpackChunkName: &quot;actioncable&quot; */ &quot;@rails/actioncable/src&quot;)
return createConsumer()</pre>

<p>}</p>

<p>export async function subscribeTo(channel, mixin) {</p>

<pre>const { subscriptions } = await getConsumer()
