...
<title>turbo.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/turbo-rails/app/assets/javascripts/turbo.js">
...
<p>if (customElements.get(“turbo-cable-stream-source”) === undefined) {</p>

<pre class="ruby"><span class="ruby-identifier">customElements</span>.<span class="ruby-identifier">define</span>(<span class="ruby-string">&quot;turbo-cable-stream-source&quot;</span>, <span class="ruby-constant">TurboCableStreamSourceElement</span>);
</pre>
...
<p>function determineFetchMethod(submitter, body, form) {</p>

<pre>const formMethod = determineFormMethod(submitter);
...
<p>function determineFormMethod(submitter) {</p>

<pre>if (submitter instanceof HTMLButtonElement || submitter instanceof HTMLInputElement) {
...
<p>function isBodyInit(body) {</p>

<pre>return body instanceof FormData || body instanceof URLSearchParams;</pre>
