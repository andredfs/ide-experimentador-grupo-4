...
<title>binding_observer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/core/binding_observer.d.ts">

<p>import { Action } from “./action”; import { Binding } from “./binding”; import { Context } from “./context”; import { ErrorHandler } from “./error_handler”; import { Schema } from “./schema”; import { Token, ValueListObserverDelegate } from “../mutation-observers”; export interface BindingObserverDelegate extends ErrorHandler {</p>

<pre>bindingConnected(binding: Binding): void;
bindingDisconnected(binding: Binding, clearEventListeners?: boolean): void;</pre>

<p>} export declare class BindingObserver implements ValueListObserverDelegate&lt;Action&gt; {</p>

<pre>readonly context: Context;
private delegate;
...
elementUnmatchedValue(element: Element, action: Action): void;</pre>
