...
<title>outlet_observer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/core/outlet_observer.d.ts">

<p>import { Multimap } from “../multimap”; import { AttributeObserverDelegate } from “../mutation-observers”; import { SelectorObserverDelegate } from “../mutation-observers”; import { Context } from “./context”; import { Controller } from “./controller”; declare type OutletObserverDetails = {</p>

<pre>outletName: string;</pre>

<p>}; export interface OutletObserverDelegate {</p>

<pre>outletConnected(outlet: Controller, element: Element, outletName: string): void;
outletDisconnected(outlet: Controller, element: Element, outletName: string): void;</pre>

<p>} export declare class OutletObserver implements AttributeObserverDelegate, SelectorObserverDelegate {</p>
