...
<title>controller.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/core/controller.d.ts">

<p>import { Application } from “./application”; import { Constructor } from “./constructor”; import { Context } from “./context”; import { OutletPropertiesBlessing } from “./outlet_properties”; import { ValueDefinitionMap } from “./value_properties”; export declare type ControllerConstructor = Constructor&lt;Controller&gt;; declare type DispatchOptions = Partial&lt;{</p>

<pre>target: Element | Window | Document;
detail: Object;
prefix: string;
bubbles: boolean;
cancelable: boolean;</pre>

<p>}&gt;; export declare class Controller&lt;ElementType extends Element = Element&gt; {</p>

<pre>static blessings: (typeof OutletPropertiesBlessing)[];
...
connect(): void;
disconnect(): void;
dispatch(eventName: string, { target, detail, prefix, bubbles, cancelable, }?: DispatchOptions): CustomEvent&lt;Object&gt;;</pre>
