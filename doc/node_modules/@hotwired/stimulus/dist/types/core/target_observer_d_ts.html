...
<title>target_observer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/core/target_observer.d.ts">

<p>import { Multimap } from “../multimap”; import { Token, TokenListObserverDelegate } from “../mutation-observers”; import { Context } from “./context”; export interface TargetObserverDelegate {</p>

<pre>targetConnected(element: Element, name: string): void;
targetDisconnected(element: Element, name: string): void;</pre>

<p>} export declare class TargetObserver implements TokenListObserverDelegate {</p>
