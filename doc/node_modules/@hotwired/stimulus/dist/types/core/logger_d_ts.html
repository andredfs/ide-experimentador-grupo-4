...
<title>logger.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/core/logger.d.ts">

<p>export interface Logger {</p>

<pre>log(message: string, ...args: any[]): void;
