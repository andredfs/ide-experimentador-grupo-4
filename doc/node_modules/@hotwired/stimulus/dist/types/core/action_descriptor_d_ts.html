...
<title>action_descriptor.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/core/action_descriptor.d.ts">

<p>import type { Controller } from “./controller”; export declare type ActionDescriptorFilters = Record&lt;string, ActionDescriptorFilter&gt;; export declare type ActionDescriptorFilter = (options: ActionDescriptorFilterOptions) =&gt; boolean; declare type ActionDescriptorFilterOptions = {</p>

<pre>name: string;
value: boolean;
event: Event;
element: Element;
controller: Controller&lt;Element&gt;;</pre>

<p>}; export declare const defaultActionDescriptorFilters: ActionDescriptorFilters; export interface ActionDescriptor {</p>

<pre>eventTarget: EventTarget;
eventOptions: AddEventListenerOptions;
eventName: string;
identifier: string;
methodName: string;
keyFilter: string;</pre>

<p>} export declare function parseActionDescriptorString(descriptorString: string): Partial&lt;ActionDescriptor&gt;; export declare function stringifyEventTarget(eventTarget: EventTarget): “window” | “document” | undefined; export {};</p>
