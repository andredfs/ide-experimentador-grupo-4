...
<title>string_helpers.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/core/string_helpers.d.ts">

<p>export declare function camelize(value: string): string; export declare function namespaceCamelize(value: string): string; export declare function capitalize(value: string): string; export declare function dasherize(value: string): string; export declare function tokenize(value: string): RegExpMatchArray;</p>
