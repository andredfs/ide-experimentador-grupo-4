...
<title>scope_observer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/core/scope_observer.d.ts">

<p>import { ErrorHandler } from “./error_handler”; import { Schema } from “./schema”; import { Scope } from “./scope”; import { Token, ValueListObserverDelegate } from “../mutation-observers”; export interface ScopeObserverDelegate extends ErrorHandler {</p>

<pre>createScopeForElementAndIdentifier(element: Element, identifier: string): Scope;
scopeConnected(scope: Scope): void;
scopeDisconnected(scope: Scope): void;</pre>

<p>} export declare class ScopeObserver implements ValueListObserverDelegate&lt;Scope&gt; {</p>

<pre>readonly element: Element;
...
private fetchScopesByIdentifierForElement;</pre>
