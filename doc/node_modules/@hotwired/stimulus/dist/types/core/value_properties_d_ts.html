...
<title>value_properties.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/core/value_properties.d.ts">

<p>import { Constructor } from “./constructor”; export declare function ValuePropertiesBlessing&lt;T&gt;(constructor: Constructor&lt;T&gt;): PropertyDescriptorMap; export declare function propertiesForValueDefinitionPair&lt;T&gt;(valueDefinitionPair: ValueDefinitionPair, controller?: string): PropertyDescriptorMap; export declare type ValueDescriptor = {</p>
...
<p>}; export declare type ValueDescriptorMap = {</p>

<pre>[attributeName: string]: ValueDescriptor;</pre>

<p>}; export declare type ValueDefinitionMap = {</p>

<pre>[token: string]: ValueTypeDefinition;</pre>

<p>}; export declare type ValueDefinitionPair = [string, ValueTypeDefinition]; export declare type ValueTypeConstant = typeof Array | typeof Boolean | typeof Number | typeof <a href="../../../../../../Object.html"><code>Object</code></a> | typeof String; export declare type ValueTypeDefault = Array&lt;any&gt; | boolean | number | <a href="../../../../../../Object.html"><code>Object</code></a> | string; export declare type ValueTypeObject = Partial&lt;{</p>

<pre>type: ValueTypeConstant;
default: ValueTypeDefault;</pre>

<p>}&gt;; export declare type ValueTypeDefinition = ValueTypeConstant | ValueTypeDefault | ValueTypeObject; export declare type ValueType = “array” | “boolean” | “number” | “object” | “string”; export declare function parseValueTypeConstant(constant?: ValueTypeConstant): “object” | “string” | “number” | “array” | “boolean” | undefined; export declare function parseValueTypeDefault(defaultValue?: ValueTypeDefault): “object” | “string” | “number” | “array” | “boolean” | undefined; declare type ValueTypeObjectPayload = {</p>

<pre>controller?: string;
token: string;
typeObject: ValueTypeObject;</pre>

<p>}; export declare function parseValueTypeObject(payload: ValueTypeObjectPayload): “object” | “string” | “number” | “array” | “boolean” | undefined; declare type ValueTypeDefinitionPayload = {</p>

<pre>controller?: string;
token: string;
typeDefinition: ValueTypeDefinition;</pre>

<p>}; export declare function parseValueTypeDefinition(payload: ValueTypeDefinitionPayload): ValueType; export declare function defaultValueForDefinition(typeDefinition: ValueTypeDefinition): ValueTypeDefault; declare type Reader = (value: string) =&gt; any; declare type Writer = (value: any) =&gt; string; export {};</p>
