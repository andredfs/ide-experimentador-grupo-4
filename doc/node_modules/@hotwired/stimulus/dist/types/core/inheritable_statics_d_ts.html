...
<title>inheritable_statics.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/core/inheritable_statics.d.ts">

<p>import { Constructor } from “./constructor”; export declare function readInheritableStaticArrayValues&lt;T, U = string&gt;(constructor: Constructor&lt;T&gt;, propertyName: string): U[]; export declare function readInheritableStaticObjectPairs&lt;T, U&gt;(constructor: Constructor&lt;T&gt;, propertyName: string): [string, U][];</p>
