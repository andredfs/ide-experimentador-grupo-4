...
<title>blessing.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/core/blessing.d.ts">

<p>import { Constructor } from “./constructor”; export declare type Blessing&lt;T&gt; = (constructor: Constructor&lt;T&gt;) =&gt; PropertyDescriptorMap; export interface Blessable&lt;T&gt; extends Constructor&lt;T&gt; {</p>

<pre class="ruby"><span class="ruby-identifier">readonly</span> <span class="ruby-value">blessings?:</span> <span class="ruby-constant">Blessing</span><span class="ruby-operator">&lt;</span><span class="ruby-constant">T</span><span class="ruby-operator">&gt;</span>[];
</pre>

<p>} export declare function bless&lt;T&gt;(constructor: Blessable&lt;T&gt;): Constructor&lt;T&gt;;</p>
