...
<title>selectors.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/core/selectors.d.ts">

<p>export declare function attributeValueContainsToken(attributeName: string, token: string): string;</p>
