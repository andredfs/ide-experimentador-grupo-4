...
<title>value_list_observer_tests.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/tests/modules/mutation-observers/value_list_observer_tests.d.ts">

<p>import { Token, ValueListObserver, ValueListObserverDelegate } from “../../../mutation-observers”; import { ObserverTestCase } from “../../cases/observer_test_case”; export interface Value {</p>

<pre>id: number;
token: Token;</pre>

<p>} export default class ValueListObserverTests extends ObserverTestCase implements ValueListObserverDelegate&lt;Value&gt; {</p>
...
elementUnmatchedValue(element: Element, value: Value): void;</pre>
