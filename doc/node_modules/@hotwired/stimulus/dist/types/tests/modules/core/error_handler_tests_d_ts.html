...
<title>error_handler_tests.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/tests/modules/core/error_handler_tests.d.ts">

<p>import { Controller } from “../../../core/controller”; declare class ErrorWhileConnectingController extends Controller {</p>

<pre>connect(): void;</pre>

<p>} declare const ErrorHandlerTests_base: import(“../../../core/constructor”).Constructor&lt;import(“../../cases/controller_test_case”).ControllerTests&lt;ErrorWhileConnectingController&gt;&gt;; export default class ErrorHandlerTests extends ErrorHandlerTests_base {</p>

<pre>controllerConstructor: typeof ErrorWhileConnectingController;
setupApplication(): Promise&lt;void&gt;;
&quot;test errors in connect are thrown and handled by built in logger&quot;(): Promise&lt;void&gt;;
&quot;test errors in connect are thrown and handled by window.onerror&quot;(): Promise&lt;void&gt;;</pre>
