...
<title>action_params_case_insensitive_tests.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/tests/modules/core/action_params_case_insensitive_tests.d.ts">

<p>import ActionParamsTests from “./action_params_tests”; export default class ActionParamsCaseInsensitiveTests extends ActionParamsTests {</p>

<pre>identifier: string[];
fixtureHTML: string;
...
&quot;test passing params to namespaced controller&quot;(): Promise&lt;void&gt;;</pre>
