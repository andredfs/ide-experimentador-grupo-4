...
<title>action_timing_tests.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/tests/modules/core/action_timing_tests.d.ts">

<p>import { Controller } from “../../../core/controller”; declare class ActionTimingController extends Controller {</p>

<pre>static targets: string[];
buttonTarget: HTMLButtonElement;
event?: Event;
connect(): void;
record(event: Event): void;</pre>

<p>} declare const ActionTimingTests_base: import(“../../../core/constructor”).Constructor&lt;import(“../../cases/controller_test_case”).ControllerTests&lt;ActionTimingController&gt;&gt;; export default class ActionTimingTests extends ActionTimingTests_base {</p>

<pre>controllerConstructor: typeof ActionTimingController;
identifier: string;
fixtureHTML: string;
&quot;test triggering an action on connect&quot;(): Promise&lt;void&gt;;</pre>
