...
<title>outlet_order_tests.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/tests/modules/core/outlet_order_tests.d.ts">

<p>import { OutletController } from “../../controllers/outlet_controller”; declare class OutletOrderController extends OutletController {</p>

<pre>connect(): void;</pre>

<p>} declare const OutletOrderTests_base: import(“../../../core/constructor”).Constructor&lt;import(“../../cases/controller_test_case”).ControllerTests&lt;OutletOrderController&gt;&gt;; export default class OutletOrderTests extends OutletOrderTests_base {</p>

<pre>fixtureHTML: string;
get identifiers(): string[];
&quot;test can access outlets in connect() even if they are referenced before they are connected&quot;(): Promise&lt;void&gt;;</pre>
