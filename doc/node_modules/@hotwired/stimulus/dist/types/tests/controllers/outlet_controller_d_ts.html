...
<title>outlet_controller.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/tests/controllers/outlet_controller.d.ts">

<p>import { Controller } from “../../core/controller”; declare class BaseOutletController extends Controller {</p>

<pre>static outlets: string[];
alphaOutlet: Controller | null;
alphaOutlets: Controller[];
alphaOutletElement: Element | null;
alphaOutletElements: Element[];
hasAlphaOutlet: boolean;</pre>

<p>} export declare class OutletController extends BaseOutletController {</p>

<pre>static classes: string[];
...
namespacedEpsilonOutletDisconnected(_outlet: Controller, element: Element): void;</pre>
