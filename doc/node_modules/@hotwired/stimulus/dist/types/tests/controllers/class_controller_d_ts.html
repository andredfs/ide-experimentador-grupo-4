...
<title>class_controller.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/tests/controllers/class_controller.d.ts">

<p>import { Controller } from “../../core/controller”; declare class BaseClassController extends Controller {</p>

<pre class="ruby"><span class="ruby-identifier">static</span> <span class="ruby-value">classes:</span> <span class="ruby-identifier">string</span>[];
<span class="ruby-identifier">readonly</span> <span class="ruby-value">activeClass:</span> <span class="ruby-identifier">string</span>;
<span class="ruby-identifier">readonly</span> <span class="ruby-value">activeClasses:</span> <span class="ruby-identifier">string</span>[];
<span class="ruby-identifier">readonly</span> <span class="ruby-value">hasActiveClass:</span> <span class="ruby-identifier">boolean</span>;
</pre>

<p>} export declare class ClassController extends BaseClassController {</p>

<pre class="ruby"><span class="ruby-identifier">static</span> <span class="ruby-value">classes:</span> <span class="ruby-identifier">string</span>[];
<span class="ruby-identifier">readonly</span> <span class="ruby-value">hasEnabledClass:</span> <span class="ruby-identifier">boolean</span>;
<span class="ruby-identifier">readonly</span> <span class="ruby-value">enabledClass:</span> <span class="ruby-identifier">string</span>;
<span class="ruby-identifier">readonly</span> <span class="ruby-value">enabledClasses:</span> <span class="ruby-identifier">string</span>[];
<span class="ruby-identifier">readonly</span> <span class="ruby-value">loadingClass:</span> <span class="ruby-identifier">string</span>;
<span class="ruby-identifier">readonly</span> <span class="ruby-value">successClass:</span> <span class="ruby-identifier">string</span>;
<span class="ruby-identifier">readonly</span> <span class="ruby-value">successClasses:</span> <span class="ruby-identifier">string</span>[];
</pre>
