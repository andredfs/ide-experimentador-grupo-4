...
<title>target_controller.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/tests/controllers/target_controller.d.ts">

<p>import { Controller } from “../../core/controller”; declare class BaseTargetController extends Controller {</p>

<pre>static targets: string[];
alphaTarget: Element | null;
alphaTargets: Element[];
hasAlphaTarget: boolean;</pre>

<p>} export declare class TargetController extends BaseTargetController {</p>
...
recursiveTargetDisconnected(_element: Element): void;</pre>
