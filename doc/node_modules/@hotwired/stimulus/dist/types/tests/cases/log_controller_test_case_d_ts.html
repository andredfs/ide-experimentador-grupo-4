...
<title>log_controller_test_case.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/tests/cases/log_controller_test_case.d.ts">

<p>import { LogController, ActionLogEntry } from “../controllers/log_controller”; import { ControllerConstructor } from “../../core/controller”; declare const LogControllerTestCase_base: import(“../../core/constructor”).Constructor&lt;import(“./controller_test_case”).ControllerTests&lt;LogController&gt;&gt;; export declare class LogControllerTestCase extends LogControllerTestCase_base {</p>

<pre>controllerConstructor: ControllerConstructor &amp; {
    actionLog: ActionLogEntry[];
};
setup(): Promise&lt;void&gt;;
assertActions(...actions: any[]): void;
assertNoActions(): void;
get actionLog(): ActionLogEntry[];</pre>
