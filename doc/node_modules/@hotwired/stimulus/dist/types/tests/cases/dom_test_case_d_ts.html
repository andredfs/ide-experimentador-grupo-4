...
<title>dom_test_case.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/tests/cases/dom_test_case.d.ts">

<p>import { TestCase } from “./test_case”; interface TriggerEventOptions {</p>

<pre>bubbles?: boolean;
setDefaultPrevented?: boolean;</pre>

<p>} export declare class DOMTestCase extends TestCase {</p>

<pre>fixtureSelector: string;
fixtureHTML: string;
