...
<title>observer_test_case.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/tests/cases/observer_test_case.d.ts">

<p>import { DOMTestCase } from “./dom_test_case”; export interface Observer {</p>

<pre>start(): void;
stop(): void;</pre>

<p>} export declare class ObserverTestCase extends DOMTestCase {</p>
...
get testCalls(): any[][];
recordCall(methodName: string, ...args: any[]): void;</pre>
