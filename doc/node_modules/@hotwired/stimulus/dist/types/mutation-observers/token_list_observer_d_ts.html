...
<title>token_list_observer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/mutation-observers/token_list_observer.d.ts">

<p>import { AttributeObserverDelegate } from “./attribute_observer”; export interface Token {</p>
...
<p>} export interface TokenListObserverDelegate {</p>

<pre>tokenMatched(token: Token): void;
tokenUnmatched(token: Token): void;</pre>

<p>} export declare class TokenListObserver implements AttributeObserverDelegate {</p>

<pre>private attributeObserver;
private delegate;
...
private readTokensForElement;</pre>
