...
<title>attribute_observer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/mutation-observers/attribute_observer.d.ts">

<p>import { ElementObserverDelegate } from “./element_observer”; export interface AttributeObserverDelegate {</p>

<pre>elementMatchedAttribute?(element: Element, attributeName: string): void;
elementAttributeValueChanged?(element: Element, attributeName: string): void;
elementUnmatchedAttribute?(element: Element, attributeName: string): void;</pre>

<p>} export declare class AttributeObserver implements ElementObserverDelegate {</p>

<pre>attributeName: string;
private delegate;
...
elementAttributeChanged(element: Element, attributeName: string): void;</pre>
