...
<title>selector_observer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/mutation-observers/selector_observer.d.ts">

<p>import { ElementObserverDelegate } from “./element_observer”; export interface SelectorObserverDelegate {</p>

<pre>selectorMatched(element: Element, selector: string, details: object): void;
selectorUnmatched(element: Element, selector: string, details: object): void;
selectorMatchElement?(element: Element, details: object): boolean;</pre>

<p>} export declare class SelectorObserver implements ElementObserverDelegate {</p>

<pre>private readonly elementObserver;
