...
<title>string_map_observer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/mutation-observers/string_map_observer.d.ts">

<p>export interface StringMapObserverDelegate {</p>

<pre>getStringMapKeyForAttribute(attributeName: string): string | undefined;
...
stringMapKeyRemoved?(key: string, attributeName: string, oldValue: string | null): void;</pre>

<p>} export declare class StringMapObserver {</p>
...
private get recordedAttributeNames();</pre>
