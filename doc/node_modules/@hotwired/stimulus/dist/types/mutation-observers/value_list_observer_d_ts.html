...
<title>value_list_observer.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/mutation-observers/value_list_observer.d.ts">

<p>import { Token, TokenListObserverDelegate } from “./token_list_observer”; export interface ValueListObserverDelegate&lt;T&gt; {</p>

<pre>parseValueForToken(token: Token): T | undefined;
elementMatchedValue(element: Element, value: T): void;
elementUnmatchedValue(element: Element, value: T): void;</pre>

<p>} export declare class ValueListObserver&lt;T&gt; implements TokenListObserverDelegate {</p>

<pre>private tokenListObserver;
private delegate;
