...
<title>indexed_multimap.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/multimap/indexed_multimap.d.ts">

<p>import { Multimap } from “./multimap”; export declare class IndexedMultimap&lt;K, V&gt; extends Multimap&lt;K, V&gt; {</p>

<pre>private keysByValue;
constructor();
get values(): V[];
add(key: K, value: V): void;
delete(key: K, value: V): void;
hasValue(value: V): boolean;
getKeysForValue(value: V): K[];</pre>
