...
<title>multimap.d.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@hotwired/stimulus/dist/types/multimap/multimap.d.ts">

<p>export declare class Multimap&lt;K, V&gt; {</p>

<pre>private valuesByKey;
constructor();
get keys(): K[];
get values(): V[];
get size(): number;
