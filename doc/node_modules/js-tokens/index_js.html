...
<main role="main" aria-label="Page node_modules/js-tokens/index.js">

<p>// Copyright 2014, 2015, 2016, 2017, 2018 Simon Lydell // License: MIT. (See LICENSE.)</p>
...
<p>// This regex comes from regex.coffee, and is inserted here by generate-index.js // (run ‘npm run build`). exports.default = /(([’“])(?:(?!<a href=”sS“>2|\).|\(?:rn|</a>))*(2)?|‘(?:[^`\$]|\[sS]|$(?!{)|${(?:[^{}]|{[^}]*}?)*}?)*(`)?)|(//.*)|(/*(?:[^<strong>]|</strong>(?!/))*(*/)?)|(/(?!*)(?:[(?:(?![]\]).|\.)*]|(?![/]\]).|\.)+/(?:(?!<a href=”u0080-uFFFF$\’“~({”>s*(?:b|</a>|[+-!](?!=)|.?<a href=“gmiyus”>d))|</a>{1,6}<a href=“u0080-uFFFF$\”>b(?!</a>|<a href=“+-*%&amp;|^&lt;&gt;!=?({”>s*(?:</a>|/(?![/*])))))|(<a href="xX">0</a>[<a href=“oO”>da-fA-F]+|0</a>[<a href="bB">0-7]+|0</a>[<a href="eE">01]+|(?:d*.d+|d+.?)(?:</a>[+-]?<a href=“$wu0080-uFFFF”>d+)?)|((?!d)(?:(?!s)</a>|\<a href="\da-fA-F">u</a>{4}|\u{[da-fA-F]+})+)|(–|++|&amp;&amp;||||=&gt;|.{3}|(?:[+-/%&amp;|^]|*{1,2}|&lt;{1,2}|&gt;{1,3}|!=?|={1,2})=?|[?~.,:;[](){}])|(s+)|(^$|[sS])/g</p>

<p>exports.matchToToken = function(match) {</p>

<pre>var token = {type: &quot;invalid&quot;, value: match[0], closed: undefined}
